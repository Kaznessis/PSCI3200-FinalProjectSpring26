...
A summary statistics table reports the mean, standard deviation, minimum, and maximum for `ln_total_exports` and the healthcare barrier outcomes used in the analysis.
