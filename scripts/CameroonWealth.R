############################################################
# CAMEROON 2004: CLUSTER-LEVEL WEALTHS VS HISTORICAL EXTRACTION
############################################################
...
capture.output(
  summary(model_wealth_cluster),
  file = "outputs/assignment3/Cameroon_2004_cluster_wealth_regression_summary.txt"
)

ggsave(
  filename = "outputs/assignment3/Cameroon_2004_cluster_wealth_regression_plot.png",
  plot = last_plot(),
  width = 8,
  height = 6,
  dpi = 300
